...
directory; v0.1 works end to end.
...
Arrays, heap allocation, closures, generics, modules, methods, enums, bitwise
ops, unsigned ints, a standard library. Pointer lifetimes are C-like, not
borrow-checked — dangling pointers trap at runtime but are not prevented.
